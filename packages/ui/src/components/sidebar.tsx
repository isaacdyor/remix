...
import { Separator } from "@remix/ui/components/separator";
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@remix/ui/components/sheet";
import { Skeleton } from "@remix/ui/components/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@remix/ui/components/tooltip";
import { useIsMobile } from "@remix/ui/hooks/use-mobile";
import { cn } from "@remix/ui/lib/utils";
import { cva, type VariantProps } from "class-variance-authority";
import { PanelLeftIcon } from "lucide-react";
// biome-ignore lint/performance/noNamespaceImport: shadcn's generated sidebar uses React namespace types throughout.
